...
def menu():
    f1 = open(r'C:\Users\thiba\Contacts\Desktop\ProjetEnigma\test\nomFichier.txt', 'r', encoding='utf8')
    f2 = open(r'C:\Users\thiba\Contacts\Desktop\ProjetEnigma\test\nomFichier.txt', 'a', encoding='utf8')
    if (len(f1.read()) < 255):
...
def LectureMessage(f3=open(r'C:\Users\thiba\Contacts\Desktop\ProjetEnigma\test\nomFichier.txt', 'r', encoding='utf8'), mess = str):
    global texte
    mess = f3.readline()
    mess = mess.replace(" ", "")
    ...
    mess = mess.upper()
    texte = mess
def SauvegardeMessage(f4=open(r'C:\Users\thiba\Contacts\Desktop\ProjetEnigma\test\nomFichier2.txt', 'a', encoding='utf8')):
    f4.write(texte)
    f4.close()
